...
pops = {
	...
	MIL_TO_JOIN_REBEL = 10, -- Rebels over this will join a faction
	MIL_TO_JOIN_RISING = 8, -- Rebels over this will join a general rising
	MIL_TO_AUTORISE = 9, -- Rebels over this rise no matter what
	REDUCTION_AFTER_RISEING = 10, -- After a pop spawns a rebellion, its militancy will be reduced this much
...
ai =
{
	...
	TWS_AWARENESS_SCORE_LOW_CAP = 0.5, -- AI will always add CBs if current warscore is less then that number (including TWS)
